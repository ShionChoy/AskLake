"""Synthetic CRM connector (Plan 2 generalization proof). Deterministic — no randomness — so the
gold set is stable. The engine never imports this; it is dataset-specific config, exactly like
datasets/imdb_cmu/source.py. Output parquet is gitignored and regenerable via `make build-crm`."""
